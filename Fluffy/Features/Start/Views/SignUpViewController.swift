...
class SignUpViewController: UIViewController {
    ...
    @IBOutlet weak var questionStackView1: CustomQ_A!
    @IBOutlet weak var questionStackView2: CustomQ_A!
    ...
    override func viewDidLoad() {
        ...
        questionStackView1.setStackView(false, UIImage(named: "Chat")!, "답변을 입력하세요.", "키우는 반려동물의 이름은?")
        questionStackView1.translatesAutoresizingMaskIntoConstraints = false
        
        questionStackView2.setStackView(false, UIImage(named: "Chat")!, "답변을 입력하세요.", "키우는 반려동물의 이름은?")
        questionStackView2.translatesAutoresizingMaskIntoConstraints = false
